...
from app.models.schemas import AgentAction, Environment, HttpVerb, RiskLevel, RiskScoreResult
...
def score(action: AgentAction) -> RiskScoreResult:
    ...
    return RiskScoreResult(risk_score=risk_score, risk_level=level, factors=factors)
