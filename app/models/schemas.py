...
class AgentAction(BaseModel):
    ...
    verb: HttpVerb
    resource: str = Field(..., description="Logical resource, e.g. table:name or api:/orders")
...
class PolicyCreate(BaseModel):
    ...
    verbs: list[str] | None = Field(default=None, description="If set, action verb must be in list.")
    environments: list[str] | None = Field(default=None, description="If set, environment must match.")
    effect: PolicyEffect
